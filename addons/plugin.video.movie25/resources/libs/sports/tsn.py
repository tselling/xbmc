...
def TSNDIR():
        main.addDir('Featured','http://esi.ctv.ca/datafeedrss/vhBinData.aspx?bid=14070',97,"%s/art/tsn.png"%selfAddon.getAddonInfo("path"))
        main.addDir('NHL','nhl',96,"%s/art/tsn.png"%selfAddon.getAddonInfo("path"))
        main.addDir('NFL','nfl',96,"%s/art/tsn.png"%selfAddon.getAddonInfo("path"))
        main.addDir('NBA','nba',96,"%s/art/tsn.png"%selfAddon.getAddonInfo("path"))
        main.addDir('Hockey Canada','canadian_hockey',96,"%s/art/tsn.png"%selfAddon.getAddonInfo("path"))
        main.addDir('CFL','cfl',96,"%s/art/tsn.png"%selfAddon.getAddonInfo("path"))
        main.addDir('MLB','mlb',96,"%s/art/tsn.png"%selfAddon.getAddonInfo("path"))
        main.addDir('Soccer','soccer',96,"%s/art/tsn.png"%selfAddon.getAddonInfo("path"))
        main.addDir('Curling','http://esi.ctv.ca/datafeedrss/vhBinData.aspx?bid=1524',97,"%s/art/tsn.png"%selfAddon.getAddonInfo("path"))
        main.addDir('Golf','http://esi.ctv.ca/datafeedrss/vhBinData.aspx?bid=1126',97,"%s/art/tsn.png"%selfAddon.getAddonInfo("path"))
        main.addDir('Tennis','http://esi.ctv.ca/datafeedrss/vhBinData.aspx?bid=1124',97,"%s/art/tsn.png"%selfAddon.getAddonInfo("path"))
        main.addDir('NLL','http://esi.ctv.ca/datafeedrss/vhBinData.aspx?bid=5995',97,"%s/art/tsn.png"%selfAddon.getAddonInfo("path"))
        main.addDir('X Games','http://esi.ctv.ca/datafeedrss/vhBinData.aspx?bid=3133',97,"%s/art/tsn.png"%selfAddon.getAddonInfo("path"))
        main.addDir('TSN Shows','shows',96,"%s/art/tsn.png"%selfAddon.getAddonInfo("path"))
        main.addDir('MMA','http://esi.ctv.ca/datafeedrss/vhBinData.aspx?bid=1134',97,"%s/art/tsn.png"%selfAddon.getAddonInfo("path"))
        main.addDir('NCAA','http://esi.ctv.ca/datafeedrss/vhBinData.aspx?bid=9981',97,"%s/art/tsn.png"%selfAddon.getAddonInfo("path"))
        main.GA("Sports","TSN")
...
def TSNLIST(murl):
        ...
        for url,name,desc,thumb in match:
            ...
            main.addSport(name,url,98,thumb,desc,'','')
